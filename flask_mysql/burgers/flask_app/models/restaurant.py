...
class Restaurant:
    ...
    @classmethod
    def save_r( cls , data ):
        query =  "INSERT INTO restaurant ( name , created_at , updated_at ) VALUES (%(name)s,NOW(),NOW());"
    ...
    def get_restaurant_with_burgers( cls , data ):
        query = "SELECT * FROM restaurant LEFT JOIN burgers ON burgers.restaurant_id = restaurant.id WHERE restaurant.id = %(id)s;"
